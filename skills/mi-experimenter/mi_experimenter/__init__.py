...
# Experiment classes (optional - may fail due to rv_toolkit API changes)
RVCausalValidator = None
CrossArchitectureSuite = None  
MLPAblator = None
...
try:
    ...
    import warnings
    warnings.warn(f"Experiment classes not available: {e}. Core functionality still works.")
